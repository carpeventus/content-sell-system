    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/publicSubmit" onsubmit="return false;"
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt ipt" name="contentTitle" autofocus="" placeholder="2-80字符">
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">摘要：</label>
                <div class="fmipt">
                    <input class="u-ipt ipt" name="contentSummary" placeholder="2-140字符">
                </div>
            </div>
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt" name="contentIcon" placeholder="图片地址">
                </div>
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <textarea class="u-ipt" name="contentDescription" rows="10" placeholder="2-1000个字符"></textarea>
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">价格：</label>
                <div class="fmipt">
                    <input class="u-ipt price" name="contentPrice">元
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">库存：</label>
                <div class="fmipt">
                    <input class="u-ipt stock" name="contentStock">件
                </div>
            </div>
